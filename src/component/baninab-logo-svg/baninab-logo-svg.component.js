...
const BaninabLogoSvg = () => (
    <svg
       ...
       <path className="six-circle" fill="#0b432d" d="M74.7,16c0,0,6.8-6.8,23.2-5.8s23.2,5.8,23.2,5.8s11.6,3.9,23.2,16.4C156,45,155,56.6,155,56.6
...
C67,22.8,74.7,16,74.7,16z" />
					<path className="five-circle" fill="#0b432d" d="M177.3,5.4c0,0,9.7-2.9,23.2,4.8s19.4,21.3,19.4,21.3s5.8,11.6,1.9,22.3s-13.5,12.6-13.5,12.6
s-12.6,3.9-26.1-4.8s-18.4-21.3-18.4-21.3s-5.8-11.6-1.9-21.3S171.5,6.3,177.3,5.4z" />
					<path className="four-circle" fill="#0b432d" d="M236.3,66.3c0,0,5.8-16.4,24.2-10.6s20.3,23.2,20.3,26.1c0,2.9,1.9,12.6-8.7,20.3c-10.6,7.7-23.2-1-23.2-1
s-6.8-3.9-10.6-12.6S234.4,75,236.3,66.3z" />
					<path className="three-circle" fill="#0b432d" d="M265.3,120.5c0,0,7.7-7.7,19.4-1s10.6,21.3,10.6,21.3s1,11.6-8.7,19.4s-20.3,0-20.3,0s-8.7-5.8-9.7-18.4
C255.7,129.2,265.3,120.5,265.3,120.5z" />
					<path className="two-circle" fill="#0b432d" d="M241.2,177.6c0,0,8.7-10.6,21.3-7.7c12.6,2.9,16.4,13.5,16.4,13.5s6.8,14.5-3.9,27.1s-24.2,8.7-24.2,8.7
s-10.6-1-15.5-14.5C230.5,191.1,240.2,178.6,241.2,177.6z" />
					<path  className="one-circle" fill="#0b432d" d="M176.3,211.5c0,0,14.5-14.5,32.9-12.6c18.4,1.9,22.3,14.5,22.3,14.5s7.7,15.5-8.7,33.9c0,0-9.7,9.7-21.3,11.6
...
c9.1,0,16.4,7,16.4,15.5S205.7,150.5,196.6,150.5z" />
					<path className="last-circle" fill="#0b432d" d="M110.5,108.9c0,0-8.7-12.6-20.3-17.4s-21.3-6.8-39.7-6.8c-15.8,0-30.9,10-34.7,12.8c-0.4,0.5-0.9,0.8-1.4,1.2
