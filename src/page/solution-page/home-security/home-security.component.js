...
class HomeSecurity extends React.Component {
    constructor() {
        super();
        this.state = {
            SingleArticle: [],
        ...
        document.title = `${t('header__websiteTitle')} | ${t('SubSubHeader__Solutions__1')}`;
    }
            ...
            <section className="blog-single-article">
                ...
                <div className="website-container container-padding blog-container">
                    ...
                    <h1>{t('page__safe__title')}</h1>
                        ...
                        <h3>{t('page__safe__between__sliders')}</h3>
